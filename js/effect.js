...
const sliderContainer = findElement('.img-upload__effect-level');
const sliderElement = findElement('.effect-level__slider');
const effectLevel = findElement('.effect-level__value');
